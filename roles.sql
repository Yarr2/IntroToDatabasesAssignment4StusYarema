...
grant connect, update, delete, insert on database steam_clone to developer; /* so they can add games,users and other stuff to database and check results afterwards*/ 
